...
class AdminCategoryPage extends State<AdminCategory> {
  ...
  Future<List> viewCategoryItemsData() async {
    final responce = await http.get(Uri.parse(
        "https://chaitalijivani.000webhostapp.com/API_Project/category_images_view.php?data=" +
...
class Items extends StatelessWidget {
 ...
 void deleteCategoryImages(var id) {
    var url =
        "https://topstech8.000webhostapp.com/Ewishes/Category_images/category_images_unique_delete.php";
