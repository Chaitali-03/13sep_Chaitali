...
import 'package:project_tops/mycolor.dart';
...
class AdminHomePage extends State<AdminHome> {
  ...
  Future<List> viewCategoryData() async {
    final responce = await http.get(Uri.parse(
        "https://chaitalijivani.000webhostapp.com/API_Project/category_view.php"));
...
class _Items extends State<Items> {
  ...
  void deleteCategory(var id) {
    var url =
        "https://chaitalijivani.000webhostapp.com/API_Project/category_delete.php";
  ...
  void updateCategoryName(var id) {
    var url =
        "https://chaitalijivani.000webhostapp.com/API_Project/category_update.php";
    http.post(Uri.parse(url), body: {
      'id': id,
