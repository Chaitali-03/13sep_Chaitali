...
class AdminUploadPage extends State<AdminUpload> {
  ...
  final String uploadUrl =
      'https://chaitalijivani.000webhostapp.com/API_Project/upload_category_main_image.php';
  ...
  Future<void> _categoryuploadData() async {
    try {
      // API endpoint
      var url = Uri.parse(
          'https://chaitalijivani.000webhostapp.com/API_Project/subimageinsert.php');
