...
class _UploadDataPageState extends State<UploadDataPage>
{
  ...
  Future<void> _uploadData() async {
    try {
      // API endpoint
      var url = Uri.parse('https://chaitalijivani.000webhostapp.com/API/upload.php');

      // Prepare data to be sent
      var request = http.MultipartRequest('POST', url)
        ..fields['c_name'] = _textController.text
        ..files.add(await http.MultipartFile.fromPath('c_image', _imageFile.path));
