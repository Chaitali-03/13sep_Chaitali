import 'package:bloc_concept/bloc/justDataBloc.dart';
import 'package:bloc_concept/ui_components/imageCard.dart';
          ...
          Expanded(
            child: Stack(
              ...
              children: <Widget>[
                ...
                imageCard('assets/images/dog.jpg'),
                Column(
            ...
            children: <Widget>[
              Expanded(
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    justDataBloc.feedJustData('Jerru');
                  },
                  child: Text(
                    'Tell Them',
                    style: TextStyle(
